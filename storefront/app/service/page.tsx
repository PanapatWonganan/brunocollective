...
const SECTIONS = [
  {
    ...
    body: (
      <>
        <p>
          ทุกออเดอร์แพ็คด้วยมือจากสตูดิโอของเราเอง และจัดส่งทั่วประเทศไทย
          พร้อมเลขติดตามพัสดุ — every order is packed by hand in Thailand and
  ...
  },
  {
    ...
    body: (
      <>
        <p>
          สตูดิโอของเราเปิดรับนัดหมายส่วนตัว — ลองสัมผัสผ้าจริง ลองไซส์
