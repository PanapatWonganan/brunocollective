  ...
  return (
    <main className={styles.page}>
      ...
      <ul>
        ...
        <li>
          <strong>ลองใส่เสมือนจริง (Virtual Try-On)</strong> — รูปที่คุณอัปโหลดเพื่อลองใส่สินค้า
          จะถูกส่งไปประมวลผลกับผู้ให้บริการ AI (Google) เพื่อสร้างภาพจำลองเท่านั้น
          เราไม่บันทึกรูปของคุณหรือภาพผลลัพธ์ไว้ในระบบ
        </li>
        <li>
          <strong>ลองใส่สดผ่านกล้อง (Live Try-On)</strong> — เมื่อคุณกดเริ่มและอนุญาตให้ใช้กล้อง
          ภาพจากกล้องจะถูกส่งตรงไปประมวลผลแบบเรียลไทม์กับผู้ให้บริการ AI (Decart) ตามนโยบายของผู้ให้บริการ
          เราไม่บันทึกหรือเก็บวิดีโอไว้ และการสตรีมหยุดทันทีเมื่อคุณปิดหน้าต่าง
        </li>
      </ul>
